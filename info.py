...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7965267063 5518489725').split()]
...
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+avUQP0oEXM44ZGM1')
...
DATABASE_URI_1 = environ.get('DATABASE_URI_1', "mongodb+srv://rivalslabretrace_db_user:0hAUoJaCpRGKmhiQ@cluster0.42wosou.mongodb.net/?appName=Cluster0")
DATABASE_URI_2 = environ.get('DATABASE_URI_2', "mongodb+srv://anyhowsleeklend_db_user:7JCOzInLvKsBwn8z@cluster0.qenvjp5.mongodb.net/?appName=Cluster0")
DATABASE_URI_3 = environ.get('DATABASE_URI_3', "mongodb+srv://gustolardtutor_db_user:mV5bLkcuN1W9ZsBW@cluster0.ioi8fcb.mongodb.net/?appName=Cluster0")
DATABASE_URI_4 = environ.get('DATABASE_URI_4', "mongodb+srv://resultpoisonpug_db_user:WzlDHzHbNYBON3bY@cluster0.gp0plhl.mongodb.net/?appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SPIDEYOFFICIAL_777') #Support group link ( make sure bot is admin )
FILE_STORE_CHANNEL = int(environ.get('FILE_STORE_CHANNEL', '-1002294764885'))
PUBLIC_FILE_STORE = int(environ.get('PUBLIC_FILE_STORE', '-1002294764885'))
#---------------------------------------------------------------
#---------------------------------------------------------------
# Spidey ig downloader 
SPIDEY_CHANNEL = int(environ.get('SPIDEY_CHANNEL', '-1002423451263'))
#---------------------------------------------------------------
#---------------------------------------------------------------
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002461263750 -1002470391435').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Spideyofficial777</b>")
APPROVED = environ.get("APPROVED_WELCOME", "on").lower()
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/SPIDEYOFFICIAL_777/12")
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/bp_.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'https://spideyofficial777.netlify.app')
